function state = computeInitDispTEDFM(model, state, uu, varargin)
%
%
% SYNOPSIS:
...
%}
    ...
    if (opt.mech_equil)
        ...
        mechmodel = MechanicModelTEDFM(mechModel.G, mechModel.rock, mechModel.mech);
    ...
    state = addDerivedQuantitiesTEDFM(mechmodel, state);
