classdef MechFluidSplitModelTEDFM < ReservoirModel
%
%
% SYNOPSIS:
...
%}
    ...
    methods
        function model = MechFluidSplitModelTEDFM(G, rock, fluid, mech_problem, varargin)
            ...
            if ~ismember('createAugmentedGridTEDFM', model.G.type)
                model.G = createAugmentedGridTEDFM(model.G);
            end
            ...
            model.gas = ...
               ~isempty(regexp(fluidModelType, '\<(gas|blackoil)\>', 'once'));
            ...
            model.mechModel = MechanicModelTEDFM(model.G, rock, mech_problem, ...
                                            rest{:}); %modified MechanicModel to MechanicModelTEDFM
        ...
        function [state, report] = updateAfterConvergence(model, state0, state, dt, drivingForces)
            ...
            state = addDerivedQuantitiesTEDFM(model.mechModel, state);
        end
